...
class KasirLaporanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kasir.laporan', compact('petugas','data'));
    }
    ...
    public function exportPdf(Request $request)
{
    ...
    // 🔹 KASIR BERDASARKAN USER LOGIN
    $kasirLogin = Auth::user();
    $query->where('id_users', $kasirLogin->id);
    $namaKasir = $kasirLogin->name;
